...
{	
	...
	public:
		...
		//! @param encoding		QHDB::UTF8, QHDB::UTF16LE, QHDB::UTF16BE, QHDB::UTF16 (native byte order) or QHDB::UTF16_ALIGNED (sqlite3_create_collation only)
...
//void BindZeroBlob64(int column, uint64 length) const;
	...
	protected:
		...
		T GetColumnValue(S sql, T(QHDB::SQLiteStatement::*getColumnFunc)(int columnNumber)const, T defaultReturnValue);
